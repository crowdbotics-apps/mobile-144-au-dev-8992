...
export default function apiReducer(state = initialState, action) {
  switch (action.type) {
    case types.NEWPLUGIN14AUGUST_GET__READ:
    case types.NEWPLUGIN14AUGUST_GET__READ_SUCCEEDED:
    case types.NEWPLUGIN14AUGUST_GET__READ_FAILED:
    case types.NEWPLUGIN14AUGUST_GET_HTTPS__CROWDBOTICSSLACKDEVHEROKUAPPCOM_DASHBOARD_APP_8992_STORYBOARD_9884_LIST:
    case types.NEWPLUGIN14AUGUST_GET_HTTPS__CROWDBOTICSSLACKDEVHEROKUAPPCOM_DASHBOARD_APP_8992_STORYBOARD_9884_LIST_SUCCEEDED:
    case types.NEWPLUGIN14AUGUST_GET_HTTPS__CROWDBOTICSSLACKDEVHEROKUAPPCOM_DASHBOARD_APP_8992_STORYBOARD_9884_LIST_FAILED:
    case types.PLUGIN11_GET__READ:
    case types.PLUGIN11_GET__READ_SUCCEEDED:
    case types.PLUGIN11_GET__READ_FAILED:
